...
public class ProfilesConfigScreen extends GameOptionsScreen {
    ...
    protected void addOptions() {
        ...
        if (i == 1) {
            TextWidget textWidget = new TextWidget(Text.of("You have no profiles."), this.client.textRenderer);
    ...
    private void initBodyHeader() {
        ...
        TextWidget key = new TextWidget(50, 20, Text.of("Key"), this.client.textRenderer).alignCenter();
