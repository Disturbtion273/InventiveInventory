...
public class Sorter {
    ...
    private static void sortPlayerInventory(ScreenHandler screenHandler) {
        if (SorterHelper.cursorCleared(PlayerSlots.getFullInventory(), screenHandler)) {
            SorterHelper.mergeItemStacks(PlayerSlots.getUpperInventory(), screenHandler);
            SorterHelper.sortItemStacks(PlayerSlots.getUpperInventory(), screenHandler);
        } else {
